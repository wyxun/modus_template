...
#define PT32_SCL_PORTS(X, V) X(V, PT32_GPIOB->IDR, PT32_GPIOB->BSRR, PT32_SCL_PINS)
#define PT32_SDA_PORTS(X, V) X(V, PT32_GPIOB->IDR, PT32_GPIOB->BSRR, PT32_SDA_PINS)
...
MDI_ADC_MEAN_GROUP_BIND(adc1_mean, adc1_dma, g_awPt32AdcDma,
                        ...
                        PT32_ADC1->RATE_HZ, 80000000U)
MDI_ADC_TRIGGER_BIND(adc1_mean, PT32_ADC1->CONTROL, UINT32_C(1))
